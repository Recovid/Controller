...
extern const float P_PLATEAU_SLOPE;
extern const float P_PLATEAU_MEAN;
extern const float MOTOR_STEP_TIME_US_MIN;
extern const float CALIB_STEP_TIME_S; 
extern const float CALIB_MAGIC_RATIO;
