...
bool PRINT(test_send)
    ...
    TEST_ASSUME(strcmp(SET_frame, "SET_ VTmax:1000\tCS8:67\n")==0);
    ...
    TEST_ASSUME(strcmp(RESP_frame, "RESP IE___:20 FR___:18 VTe__:300 PCRET:41 VM___:+00 PPLAT:19 PEP__:05\tCS8:6D\n")==0);
    return true;
}
