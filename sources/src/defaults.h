...
#define DEFAULT_setting_FR_pm          (20) //!< \see set_setting_FR_pm to set it within the range defined by     VT, Vmax, EoI
#define DEFAULT_setting_VT_mL          (600)//!< \see set_setting_VT_mL to set it within the range defined by FR,     Vmax, EoI
#define DEFAULT_setting_Vmax_Lpm       (40) //!< \see set_setting_Vmax_Lpm to set it within the range defined by FR, VT,       EoI
