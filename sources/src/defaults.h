...
#define DEFAULT_setting_VT_mL          (400)//!< \see set_setting_VT_mL to set it within the range defined by FR,     Vmax, EoI
#define DEFAULT_setting_Vmax_Lpm       (30) //!< \see set_setting_Vmax_Lpm to set it within the range defined by FR, VT,       EoI
